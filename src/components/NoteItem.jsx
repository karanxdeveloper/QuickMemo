...
function NoteItem({note}) {
  return (
    ...
    className="note flex flex-col justify-between rounded-[1rem] p-2 max-h-[130px] gap-[3px] bg-gray-900 w-[180px]   drop-shadow-xl text-white lg:w-[398px] inset-shadow-sm inset-shadow-gray-500/50">
